...
att_mu, att_rewards, def_mu, def_rewards = cem_pq(g, iters = 1000, batch_size = 8, elite_size = 4, episode_count = 25, weight_type = 'log', temp = 1, t_max = 3600)


import os
att_fname= os.path.join('checkpoint', 'cem_att_pq_3600.pth.tar')
torch.save(att_mu.state_dict(), att_fname)

def_fname= os.path.join('checkpoint', 'cem_def_pq_3600.pth.tar')
